...
`NOTE:` DO NOT USE GOOGLE COMPUTE ENGINE (GCE) or other related Google CLoud Services. It is in violation of their TOS. Google will suspend your account, lock your files and charge you for the usage. Been there, done that!
